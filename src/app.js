...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (selectedOperator === operator.ADD) {
            ...
            result = num1 - num2;
            console.log(chalk_1.default.yellow.bgRedBright(`Result is : ${result}`));
        }
        else if (selectedOperator === operator.MULTIPLY) {
            result = num1 * num2;
            console.log(chalk_1.default.black.bgRedBright(`Result is : ${result}`));
        }
        else if (selectedOperator === operator.DIVIDE) {
            result = num1 / num2;
            console.log(chalk_1.default.blue.bgRedBright(`Result is : ${result}`));
        }
    });
}
main();
